...
class yayi2 extends char
{
    ...
    public function init()
    {
        ...
        $this->set("pursuer", 1);
        $this->set("combat_exp", 40000000);
        $this->set("attitude", "heroism");
        $this->set("vendetta_mark", "authority");
        $this->set_skill("unarmed", 70 + rand(0, 500));
        $this->set_skill("staff", 70 + rand(0, 500));
        $this->set_skill("parry", 70 + rand(0, 500));
        $this->set_skill("dodge", 70 + rand(0, 500));
        $this->set_skill("move", 100 + rand(0, 500));

        $this->set_temp("apply/attack", 70);
        $this->set_temp("apply/defense", 70);
        $this->set_temp("apply/damage", 30 + rand(0, 200));
